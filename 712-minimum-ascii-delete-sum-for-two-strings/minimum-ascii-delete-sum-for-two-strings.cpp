...
//             // the sum of ASCII of reaminig char in string
//             for(int x = i ; x<s1.size();x++) cost+=s1[x];
//             for(int x = j ; x<s2.size();x++) cost+=s2[x];
//             return cost;
//         }
//         if(s1[i]==s2[j]){
//             cost = fun(s1 , s2  , i+1 , j+1);
//         }
//         else{
//             int cost1 = s1[i]+fun(s1 , s2 , i+1,j);
//             int cost2 = s2[j]+fun(s1 , s2 , i, j+1);
...
//         }
//         if(s1[i]==s2[j]){
//             cost = fun(s1 , s2  , i+1 , j+1,dp );
//         }
//         else{
//             int cost1 = s1[i]+fun(s1 , s2 , i+1,j ,dp);
//             int cost2 = s2[j]+fun(s1 , s2 , i, j+1 ,dp);
